...
function createTooltip(span, id) {
    ...
    tooltip.style.left = tooltip_left[id] + "px";
    ...
    let link = linkCodeToExplanations(span.offsetLeft + span.offsetWidth / 2, tooltip_left[id] + tooltip_width / 2, tooltip_border_colors[span_ids.indexOf(id)]);
